...
//		}
	...
	@Override
	public List<Product> getRecommendedProducts(String category, List<Integer> excludeIds) {
		return productRepository.findTop5ByCategoryAndIdNotIn(category, excludeIds);
	}
